...
class Preprocessor:
    ...
    def impute_missing_values(self, data):
        ...
        self.data= data
        try:
            nn = self.config['estimators']['KNNImputer']['params']['n_neighbors']
            wt = self.config['estimators']['KNNImputer']['params']['weights']

            imputer = KNNImputer(n_neighbors=nn, weights=wt, missing_values=np.nan)
