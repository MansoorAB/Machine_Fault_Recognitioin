...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        try:
            for i in range (1,11):
                kmeans=KMeans(n_clusters=i,init='k-means++',random_state=self.config['base']['random_state']) # initializing the KMeans object
            ...
            self.logger_object.log(self.file_object, 'Optimum clusters: %d, plot saved at: %s' % (self.kn.knee, self.config['reports']['Kmeans_elbow_plot']))
            return self.kn.knee
